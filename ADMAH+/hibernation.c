...
//			unsigned long int value_2 = 3400 + deltaV;

			 unsigned int value_2 =(unsigned int) (VMINN + deltaV);

			 *FLAG_interrupt=2;

//			unsigned long int value_2 = VMIN2;

			Set_V(value_2);

			__delay_cycles(500); // (?) we need this delay ?s
...
//	   unsigned long int value_3 = 3400 + deltaV;

	   unsigned long int value_3 =(unsigned int) (VMINN + deltaV);

//	   unsigned long int value_3 = VMIN2;
...
//	  CalValue_3 = CalValue_3/10;
	  ...
	  deltaV= (long int) (CalValue_3 - CalValue_4);
...
//			 vmonitor_3=3400+(Counter_3*100);  //minimun value
			 ...
			 if(t==0){ //the voltage is still increasing slowly
			   ...
			   }else{  //the voltage is increasing quickly
...
//				    vmonitor_5=VMIN + (Counter_3*100);
				    ...
				    vmonitor_5 = VMIN + 600 + (Counter_3*100);
...
//		        *FLAG_interrupt==2;
		 ...
		 if (*FLAG_interrupt==4){
		   ...
		   unsigned int value_7 = VMINN + deltaV;
